...
if ($listaCards.length > 0) {
    ...
    function carregarCards() {
        ...
        // Com jQuery, usamos .empty() em vez de innerHTML = ''
        $listaCards.empty();

        if (alunos.length === 0) {
            // E usamos .html() em vez de innerHTML = '...'
        ...
        alunos.forEach(aluno => {
            ...
            // Com jQuery, usamos .append() para adicionar elementos dentro de uma div
            $listaCards.append(cardHTML);
        });
    }

    // Mantemos atrelado ao window para que o botão HTML onclick="limparDados()" consiga achá-la
